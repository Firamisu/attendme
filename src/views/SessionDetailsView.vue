<template>
  ...
  >
    ...
    <div
      v-if="error"
      class="border-2 border-red-600 p-4 text-red-600 rounded-lg"
    >
    ...
    <div v-else>
      ...
      <div
        v-if="sessionDetails"
        class="mt-4 border-2 border-black p-4 rounded-lg bg-gray-50"
      >
      ...
      <div class="mt-8">
        ...
        <div
          ...
          class="border-2 border-black p-10 text-center rounded-lg"
        >
